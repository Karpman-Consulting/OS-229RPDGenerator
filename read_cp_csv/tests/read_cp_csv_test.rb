...
class ReadComplianceParameterCsvFromOsmTest < Minitest::Test
  ...
  def test_good_argument_values
    ...
    args_hash = {}
    args_hash['empty_comp_param_json_file_path'] = "#{File.dirname(__FILE__)}/in.comp-param-emptyE1.json"
    args_hash['updated_comp_param_json_file_path'] = "#{File.dirname(__FILE__)}/ASHRAE901_OfficeSmall_STD2019_Denver.comp-param-updated_successE1.json"

    args_hash['csv_file_path'] = "#{File.dirname(__FILE__)}/Test_E1_filled.csv"
    ...
    ### Expected values must match csv
    ...
    assert_equal updated_cp_json['weather']['climate_zone'],'ACLIMATEZONE'

    assert_equal updated_cp_json["compliance_path"],'CODE_COMPLIANT456'

    assert_equal updated_cp_json.dig("ruleset_model_descriptions",0 ,"type"),'CODE_COMPLIANT123'
