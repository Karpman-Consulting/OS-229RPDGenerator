...
class BaseTestCreateOSRulesetProjectDescription(unittest.TestCase):
    def setUp(self):
        ...
        self.initial_filed_csv_file_path = os.path.join(
            os.path.dirname(__file__), "Test_E1_filled.csv"
        )
    ...
    def create_cp_csv(self):
        ...
        print(
            f"Copying {self.initial_filed_csv_file_path} to {self.filled_csv_file_path}"
        )
...
class TestCreateOSRulesetProjectDescriptionE1(
    ...
    def setUp(self):
        ...
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__), "Test_E1", "run", "Test_E1_filled.csv"
        )
...
class TestCreateOSRulesetProjectDescriptionE2(
    ...
    def setUp(self):
        ...
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__), "Test_E2", "run", "Test_E1_filled.csv"
        )
...
class TestCreateOSRulesetProjectDescriptionE3(
    ...
    def setUp(self):
        ...
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__), "Test_E3", "run", "Test_E1_filled.csv"
        )
...
class TestCreateOSRulesetProjectDescriptionF160(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_160_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_160_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF170(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_170_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_170_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF180(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_180_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_180_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF190(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_190_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_190_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF200(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_200_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_200_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF210(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_210_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_210_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF220(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_220_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_220_autosized",
...
class TestCreateOSRulesetProjectDescriptionF230(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_230_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_230_autosized",
            "run",
            "Test_E1_filled.csv",
        )
...
class TestCreateOSRulesetProjectDescriptionF240(
    ...
    def setUp(self):
        ...
        self.openstudio_model_path = os.path.join(
            os.path.dirname(__file__), "Test_F_240_autosized.osm"
        )
        self.filled_csv_file_path = os.path.join(
            os.path.dirname(__file__),
            "Test_F_240_autosized",
            "run",
            "Test_E1_filled.csv",
        )
